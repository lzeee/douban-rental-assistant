...
3. 在豆瓣上关注目的地周边的租房小组，关注多个租房小组后，“我的小组”页面将会按时间倒序展示相关帖子。

4. 浏览“我的小组”页面，使用筛选功能，快速发现目的地周边的房源信息。
...
在租房时，我曾经遇到一些有趣的工具，比如这个[租房搜索助手](http://uz.yurixu.com/manage/beijing.php)，不过由于豆瓣部分已经停更，无法使用。我的业余时间有限，没精力复刻一套类似的爬虫+展示系统，先用插件简单解决一下吧。
